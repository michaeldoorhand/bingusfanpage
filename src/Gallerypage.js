          ...
          <div className="gallery-imgs-container">
            ...
            <div className="bingus-container">
              <div className="bingus">
                <img src={dancingbing} alt="wait until the page loads" className='sidegifs'/>
              </div>
              <div className="center">
                <div className="header-text">
                  Cycle through bingus's alter egos!
                </div>
                <Slideshow
                  imgs={[halfbing0,halfbing1,halfbing2,halfbing3,halfbing4,halfbing5,halfbing6,halfbing7,halfbing8,halfbing9,halfbing10]}
                />
              </div>
              <div className="bingus">
                <img src={ketabing} alt="wait until the page loads" className='sidegifs'/>
              </div>
            </div>
